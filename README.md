...
`outputs/BIRYOMUMEISHO_JOSHUA_CAPSTONE_REPORT_FINAL.docx`
...
│   ├── data_pipeline.py            # Data split, augmentation, dataloaders (v1)
│   ├── data_pipeline_v2.py         # Data pipeline v2 (balanced batches)
│   ├── train.py                    # Training script (v1 - weighted sampler)
│   ├── train_v2.py                 # Training script (v2 - balanced batches)
│   ├── evaluate.py                 # Test set evaluation (v1)
│   ├── evaluate_v2.py              # Test set evaluation (v2)
│   ├── threshold_analysis.py       # Classification threshold optimizer (v1)
│   ├── threshold_analysis_v2.py    # Classification threshold optimizer (v2)
...
│   ├── stain_norm.py               # Reinhard stain normalization
│   ├── generate_report.py          # .docx report generator
│   ├── generate_report_figures.py  # Report figure generator
│   ├── train_normalized.py         # Training on stain-normalized data
│   ├── train_v2_alnet.py           # V2 ALNet training variant
│   ├── train_densenet121.py        # DenseNet121 benchmark
│   ├── train_efficientnet.py       # EfficientNet benchmark
...
│   └── report_figures/             # 17 figures for capstone report
├── new screenshots/                # Desktop app screenshots
├── requirements.txt
└── .gitignore
```
