...
from alnet_model import ALNet, count_parameters
...
def train():
    ...
    print(f"Loss: CrossEntropyLoss (balanced data)")
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        if epoch == 1:
            print(f"\n>>> Epoch 1 completed in {elapsed:.1f}s. Estimated total: ~{elapsed * EPOCHS / 60:.0f} min (max). Continuing...\n")
